	...
	<script>
    	$(document).ready(function(){
    		<%if(session.getAttribute("memID")==null){%>
    			...
    			$('#dealbtn').html("");
    		<%} else{%>
	    		$('#dealbtn').attr("href","./DealWrite.book");
	    		$('#dealbtn').attr("class","btn btn-primary py-2 px-4");
				$('#dealbtn').html("Resell Now");
    		<%}%>
    	});
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span>Resell <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Resell</h2>
          </div>
        </div>
      </div>
    </section>
					...
					<div class="col-md-9">
						<div class="row mb-4">
							<div class="col-md-12 d-flex justify-content-between align-items-center">
								<h4 class="product-select">Total :  ${listcount }</h4>
						...
						<c:forEach var="vo" items="${ list }">
							...
							<c:if test="${vo.d_state_image == null }">
									...
									<div class="text text-center">
										...
										<span class="category">${vo.m_id }</span>
										<h2>${vo.d_subject}</h2>
										<p class="mb-0"><span class="price"><fmt:formatNumber value="${ vo.d_price }" pattern="#,###" /></span> 원</p>
									</div>
								</div>
...
<c:otherwise>
			...
			<br><br><br>
            <font size=4>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            ...
            등록된 글이 없습니다.</font>
						...
						<div align="right">					
					   <p><a href="/team2_book/DealWrite.book" class="btn btn-primary py-2 px-4"style="padding: 1.5rem !important;" id="dealbtn">Resell Now</a> </p>
					   </div>
				          ...
				          <div class="col text-center">
				            <div class="block-27">
				              ...
				              <c:choose>
					            ...
					            <c:otherwise>
					            <li><a href="./bookDealList.book?category=${category }&page=${page-1 }">&lt;</a></li>
				            ...
				            <c:forEach var="a" begin="${startPage }" end="${endPage }" step="1">
					            ...
					            <c:otherwise>
					            <li><a href="./bookDealList.book?category=${category }&page=${a }">${a }</a></li>
              ...
              <div class="categories">
                <h3>Resell Category</h3>
                <ul class="p-0">
                
                	<li><a href="./bookDealList.book?category=1">문학 <span class="fa fa-chevron-right"></span></a></li>
	                <li><a href="./bookDealList.book?category=2">인문 <span class="fa fa-chevron-right"></span></a></li>
	                <li><a href="./bookDealList.book?category=3">사회/과학/예술 <span class="fa fa-chevron-right"></span></a></li>
	                <li><a href="./bookDealList.book?category=4">학습/수험서/자격증 <span class="fa fa-chevron-right"></span></a></li>
	                <li><a href="./bookDealList.book?category=5">만화/외국서적 <span class="fa fa-chevron-right"></span></a></li>
	                <li><a href="./bookDealList.book?category=6">기타 <span class="fa fa-chevron-right"></span></a></li>
                </ul>
              </div>
            </div>
