	...
	.signup-form .fa {
		font-size: 21px;
						...
						<div class="signup-form">
							<form action="./BookUserDelete.book" method="post" name="userDelete">
					            <div class="form-group" align="center">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-lock"></i></span>
										<input type="password" class="form-control" name="M_PWD" placeholder="Password" >
									</div>
									<input name="M_ID2" type="hidden" value="${memID }" readonly>
									<p></p>
									<button type="button" class="btn btn-primary btn-lg" onclick="javascript:delbook()">탈퇴</button>
					     		</div>
				       		</form>
						</div>
						<!-- 본문끝 -->
