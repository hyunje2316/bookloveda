...
<!-- 	      
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="product.html">Resell <i class="fa fa-chevron-right"></i></a></span> <span>ResellList <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Resell Writing</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				...
				<form action="DealInsertAction.book" method="post"	enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-12" style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="d_subject" id="subject" placeholder="Subject" required>
													</div>
												</div>
												...
												<div class="col-md-6"style="padding-bottom: 10px;"> 
													<div class="form-group">
														...
														<input type="text" class="form-control" name="d_price" id=d_price placeholder="Price" required>
													</div>
												</div>
												...
												<div class="col-md-6"style="padding-bottom: 10px;"> 
													<div class="form-group">
														...
														<input name="d_state_image" id="imgFile" type="file" required/>
													</div>
												</div>
												...
												<div class="col-md-12"style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<textarea name="d_content" class="form-control" id="d_content" cols="30" rows="10" placeholder="input content..." required></textarea>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group" align="center">
														<input type="submit" value="SUBMIT" onClick="confirmFileExtension(imgFile.value);" class="btn btn-primary">
