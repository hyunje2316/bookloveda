<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
	BookReviewVO book = (BookReviewVO)request.getAttribute("vo");
...
<html lang="en">
  <head>
    ...
    <title>BookLove多 - Review Update Form</title>
    <meta charset="utf-8">
...
<!-- 	      
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="product.html">Review <i class="fa fa-chevron-right"></i></a></span> <span>Review List <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">SUBJECT : ${ vo.r_subject }</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				...
				<form action="ReviewUpdateAction.book" method="post" name="modifyform">
											...
											<div class="row">
												...
												<div class="col-md-12" style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="r_subject" id="subject" value="${ vo.r_subject }" required>
													</div>
												</div>
												...
												<div class="col-md-6"style="padding-bottom: 10px;"> 
													<div class="form-group">
														<label class="label" for="email">평점</label><br>
															<c:if test="${ vo.r_star == 1 }">													
															<input type="radio" checked="checked"  name="r_star" value="1">★
															<input type="radio" name="r_star" value="2">★★
															<input type="radio" name="r_star" value="3">★★★
															<input type="radio" name="r_star" value="4">★★★★
															<input type="radio" name="r_star" value="5">★★★★★
														</c:if>
														
														<c:if test="${ vo.r_star == 2 }">													
															<input type="radio" name="r_star" value="1">★
															<input type="radio" checked="checked" name="r_star" value="2">★★
															<input type="radio" name="r_star" value="3">★★★
															<input type="radio" name="r_star" value="4">★★★★
															<input type="radio" name="r_star" value="5">★★★★★
														</c:if>
														...
														<c:if test="${ vo.r_star == 3 }">													
															<input type="radio" name="r_star" value="1">★
															<input type="radio" name="r_star" value="2">★★
															<input type="radio" checked="checked" name="r_star" value="3">★★★
															<input type="radio" name="r_star" value="4">★★★★
															<input type="radio" name="r_star" value="5">★★★★★
														</c:if>
														...
														<c:if test="${ vo.r_star == 4 }">													
															...
															<input type="radio" name="r_star" value="2">★★
															<input type="radio" name="r_star" value="3">★★★
															<input type="radio" checked="checked" name="r_star" value="4">★★★★
															<input type="radio" name="r_star" value="5">★★★★★
														</c:if>
														...
														<c:if test="${ vo.r_star == 5 }">													
															...
															<input type="radio" name="r_star" value="3">★★★
															<input type="radio" name="r_star" value="4">★★★★
															<input type="radio" checked="checked" name="r_star" value="5">★★★★★
														</c:if>
												...
												<div class="col-md-12"style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<textarea name="r_content" class="form-control" id="d_content" cols="30" rows="10" placeholder="input content..." required>${ vo.r_content }</textarea>
													</div>
												</div>
												<div class="col-md-12">
