...
<html lang="en">
  <head>
    ...
    <title>BookLove多 - review List View</title>
       <meta charset="utf-8">
...
window.onload = function(){
	...
	$.ajax({
		...
		success: function(data, textStatus){
			...
			memberInfo += '<form action="./ReviewCommentSubmit.book" method="post">';
			memberInfo += '<input type="hidden" name="c_board_no" value="${ vo.r_no }">';
			memberInfo += '<textarea name="rev_comment"cols="30" rows="5" class="form-control"></textarea><br>';
			...
			for(i in jsonInfo.members){
				...
				memberInfo += '<p><a style="color: #BBAA55" href="./ReviewCommDelAction.book?id=' + jsonInfo.members[i].id + '&num=${ vo.r_no }&no=' + jsonInfo.members[i].no + '">삭제</a></p>';
				memberInfo += '</div>';
				memberInfo += '</li>';
			}
			memberInfo += "</ul>";
...
<!-- 	      
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
             ...
             <li class="nav-item active"><a href="./bookReviewList.book" class="nav-link">Review</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="product.html">Review <i class="fa fa-chevron-right"></i></a></span> <span>Review detail <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Review detail</h2>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div style="width: 1170px;">
            	subject<h2 class="mb-3">${ vo.r_subject }</h2>
            <div align="right">
            <p>DATE : ${ vo.r_date }</p>
            <p>조회수 : ${ vo.r_ref }</p>
            
            <p class="text-left mr-4">
								<a href="" class="mr-2" style="color: #000;">평점: ${ vo.r_star }.0</a> &nbsp;&nbsp;
								
								<c:if test="${vo.r_star == 1 }">
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
								</c:if>
								
								<c:if test="${vo.r_star == 2 }">
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
								</c:if>
								
								<c:if test="${vo.r_star == 3 }">
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
								</c:if>
								
								<c:if test="${vo.r_star == 4 }">
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
									<a href="#"style="color: #000;"><span class="fa fa-star"></span></a>
          	...
          	<div align="center">
          		<div style="width:1000px;">
		          	<p>
		              <img src="./reviewUpload/${ vo.r_image }" alt="" class="img-fluid" >
		            </p>
	        	</div>
	            <p align="left" style="color: black;">Content</p> <br>
	            <p align="left">${vo.r_content }</p> 
	          <!--   수정/ 컨텐츠 넣는 부분이 없어서 추가함-->
	         </div>
			...
			<a href="bookReviewList.book" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important;">List</a>
			...
			<a href="bookReviewList.book" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important;">List</a> 
			 <!-- 수정중 -->
			 <form action="ReviewUpdate.book" method="post" name="modifyform" style="width: 120px;">
			<input name="num" type="hidden" value="${vo.r_no }">
 			<input name="id" type="hidden" value="${memID }">
 			<a href="javascript:modifybook()" class="btn btn-primary py-2 px-4"  style="padding: 1.5rem !important; ">Update</a> 
 			 </form>		
 			 
 			 <form action="ReviewDelete.book" method="post" name="deleteform"  style="width: 100px;" >	
 			 <input name="num" type="hidden" value="${vo.r_no }">
 			<input name="id" type="hidden" value="${memID }">
 			 <a href="javascript:deletebook()" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important;">Delete</a>
 			  </form>
...
<%--   		<a href="ReviewUpdate.book?num=${ vo.r_no }" class="btn btn-primary py-2 px-4">Update</a>  --%>
            ...
            <input type="hidden" name="r_board_no" id="r_board_no" value="${ vo.r_no }"> <!-- 글번호 -->
            <div class="pt-5 mt-5" id="review_comm">
