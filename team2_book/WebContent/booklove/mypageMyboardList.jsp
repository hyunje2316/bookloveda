      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span>My Page <i class="fa fa-chevron-right"></i></span></p>
				...
				<div class="row">
					<div class="col-md-9">
						...
						<form style="width: 170px;">
			 			...
			 			<form action="./BookMyListAction.book" method="post" style="width: 140px;">
							<input type="hidden" value="T2_DEAL" name="board">
							<input type="submit" value="거래 게시판" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important; ">
						</form>

						<form action="./BookMyListAction.book" method="post" style="width: 200px;">
							<input type="hidden" value="T2_REVIEW" name="board">
							<input type="submit" value="리뷰 게시판" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important; ">
						</form>
						
						<form action="./BookMyListAction.book" method="post" style="width: 160px;">
							<input type="hidden" value="T2_OFFLINE" name="board">
							<input type="submit" value="오프 모임 게시판" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important; ">
						</form>
  ...
  background-color: #f2f2f2;
						...
						<table border="1">
						 ...
						 <c:forEach var="vo" items="${ list }">
						  <tr>
						  	<td class="text-center" width="10%">${vo.r_no }</td>
						    <td width="50%"><a href="./${vo.m_id }.book?num=${ vo.r_no }" style="color:#000; text-decoration:underline; font-weight:bold;" >${vo.r_subject }</a></td>
						    <td class="text-center" width="25%">${vo.r_date }</td>    
						    <td class="text-center" width="15%">${vo.r_ref }</td>
						  </tr>
						</c:forEach>
						</table>
							...
							<div class="block-27">
								<ul>
									<c:choose>
										...
										<c:otherwise>
											<li><a href="./BookMyListAction.book?page=${page-1 }&board=${board}">&lt;</a></li>
									...
									<c:forEach var="a" begin="${startPage }" end="${endPage }"
										...
										<c:choose>
											...
											<c:otherwise>
												<li><a href="./BookMyListAction.book?page=${a }&board=${board}">${a }</a></li>
...
<!-- -------------------------------------------- -->
              ...
              <div class="categories">
                ...
                <ul class="p-0">
                	...
                	<li><a href="./contact.book">회원 정보 수정 <span class="fa fa-chevron-right"></span></a></li>
	                <li><a href="./userdel.book">회원 탈퇴 <span class="fa fa-chevron-right"></span></a></li>
	                <li><a href="./userboard.book">내가 쓴 게시글 <span class="fa fa-chevron-right"></span></a></li>
                </ul>
              </div>
            </div>
