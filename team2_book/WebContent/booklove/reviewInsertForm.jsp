...
<!-- 	      
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="product.html">Review <i class="fa fa-chevron-right"></i></a></span> <span>ReviewlList <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Review Writing</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				...
				<form action="ReviewInsertAction.book" method="post"	enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-12" style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="r_subject" id="subject" placeholder="Subject" required>
													</div>
												</div>
												...
												<div class="col-md-12"style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<textarea name="r_content" class="form-control" id="d_content" cols="30" rows="10" placeholder="input content..." required></textarea>
													</div>
												</div>
												<div class="col-md-12">
