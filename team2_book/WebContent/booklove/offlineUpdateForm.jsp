...
<!-- 	      
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="product.html">Club - offline <i class="fa fa-chevron-right"></i></a></span> <span>club - offline List <i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Club - Offline Writing</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				...
				<form action="OfflineUpdateAction.book" method="post">
				
				<input type="hidden" name="num" value=${ vo.o_no }>
				
								<div  style="width:1100px; background-color:white;  ">
								
									<div  style="width:1100px; background-color:white;padding: 50px;  ">
										<h3 class="mb-4">Club - Offline</h3>
											...
											<div class="row">
												...
												<div class="col-md-12" style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="o_subject" id="subject" value="${ vo.o_subject }" required>
													</div>
												</div>
												...
												<div class="col-md-6"style="padding-bottom: 10px;"> 
													<div class="form-group">
														...
														<c:if test="${ vo.o_address != null }">
																<a href="./offlineUpload/${vo.o_address}">
																<p>${vo.o_address}</p>
																</a>
														</c:if>
													</div>
												...
												<div class="col-md-12"style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<textarea name="o_content" class="form-control" id="d_content" cols="30" rows="10" required>${ vo.o_content }</textarea>
													</div>
												</div>
												<div class="col-md-12">
