      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            ...
            <h2 class="mb-0 bread">SEARCH RESULT</h2>
          </div>
        </div>
      </div>
    </section>
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row">
					...
					<form action="./searchAction.book" class="search-form">

						<div align="center" style="width: 1170px;">

							<h3 class="mb-0 bread">Search</h3>
							<br>
							<div class="form-group"
								style="width: 1000px; padding-bottom: 100px;">

								<input type="text" name="search" id="search"
									value="${ search }"
									style="width: 800px; height: 50px; border-color: #808080">
								<!--  
				           	<input type="image" src="./images/search.png"  value="" /> -->
								<button id="search"
									style="border: 0px; background-color: white;">
									<img src="./images/search4.png" width="40px" height="40px"
										id="search">
								</button>
					...
					<div style="width: 1170px; height: 30px;" align="center">
					
			<a href="./searchBook.book" >
			<p>도서검색 하러 가기</p>
   			 </a>
...
<section class="ftco-section" style="padding-top: 10px; padding-bottom: 50px;">
			<div class="container">
				<div class="row"  >
				<!-- <div style="width: 1200px; height:50px; padding-bottom: 20px;"> -->
    			<h3>RESELL LIST -------------------------------------------------------------------------------------------------------------------</h3>
    		<!-- 	</div> -->
					<div class="col-md-9" >
						<div class="row mb-4">
						...
						<c:forEach var="vo" items="${ deallist }">
							...
							<div class="col-md-4 d-flex" style="width: 300px;">
							
							
							<div class="product ftco-animate"  style="width: 300px;">
							...
							<c:if test="${vo.d_state_image == null }">
								...
								<br>
										<span style="font-size: 15pt;">${ vo.d_subject }</span>
										<%-- <h2 style="color: black;">${ vo.d_subject }</h2> --%>
										<br>
											<span class="price">${ vo.d_price } 원</span>
									</div>
								</div>
					...
					<p style="margin-left: 500px; margin-top: 50px; margin-bottom: 50px;">검색결과가 없습니다.
...
<section class="ftco-section" style="padding-top: 10px; padding-bottom: 50px;">
    		...
    		<!-- 	</div> -->
					<div class="col-md-9">
						...
						<c:forEach var="ro" items="${ reviewlist }">
							
							<div class="col-md-4 d-flex"  style="width: 300px;">
							
							
							<div class="product ftco-animate"  style="width: 300px;">
							<c:if test="${ro.r_image != null }">
							<div class="img d-flex align-items-center justify-content-center" style="background-image: url(./reviewUpload/${ ro.r_image });" >
				
						</c:if>
						
						<c:if test="${ro.r_image == null }">
							<div class="img d-flex align-items-center justify-content-center" style="background-image: url(./images/noimage.jpg);" >
				
						</c:if>					
										<div class="desc">
											<p class="meta-prod d-flex">
												 
												<a href="./ReviewDetailAction.book?num=${ ro.r_no }" class="d-flex align-items-center justify-content-center"><span class="flaticon-visibility"></span></a>
											</p>
										</div>
									</div>
									...
									<%-- 	<span class="category">${vo.d_category }</span> --%>
										...
										<span class="category">author : ${ ro.m_id }</span>
										<br>
										<span style="font-size: 15pt;">${ ro.r_subject }</span>
										<%-- <h2 style="color: black;">${ vo.d_subject }</h2> --%>
										<br>
											<span class="price">${ ro.r_date }</span>
									</div>
								</div>
    		...
    		<!-- 	</div> -->
					<div class="col-md-9">
						...
						<c:if test="${co.o_address != null }">
								<div class="img d-flex align-items-center justify-content-center" style="background-image: url(./offlineUpload/${ co.o_address });" >
								...
								<div class="img d-flex align-items-center justify-content-center" style="background-image: url(./images/noimage.jpg);" >
										...
										<div class="desc">
											<p class="meta-prod d-flex">
												...
												<a href="./OfflineViewAction.book?num=${ co.o_no }" class="d-flex align-items-center justify-content-center"><span class="flaticon-visibility"></span></a>
											</p>
										</div>
									</div>
									...
									<%-- 	<span class="category">${vo.d_category }</span> --%>
										...
										<span class="category">author : ${ co.m_id }</span>
										<br>
										<span style="font-size: 15pt;">${ co.o_subject }</span>
										<%-- <h2 style="color: black;">${ vo.d_subject }</h2> --%>
										<br>
											<span class="price">${ co.o_date }</span>
									</div>
								</div>
