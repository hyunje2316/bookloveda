<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	if( session.getAttribute("memID") != null) {
		response.sendRedirect("./home.book");
	}
...
<!-- 	 
    ...
    <section class="ftco-section">
    	<div class="container">
    		...
    		<section class="login_part section_padding" style="padding-top: 10px;">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_text text-center" style="background-image: url('images/bg_222.jpg');">
                            <div class="login_part_text_iner">
                                <h2>New to our Shop?</h2>
                                <p>There are advances being made in science and technology
                                    everyday, and a good example of this is the</p>
                                <a href="./signUp.book" class="btn_3">Create an Account</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                ...
                                <form class="row contact_form" action="./loginPro.book" method="post" novalidate="novalidate">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <button type="submit" value="submit" class="btn_3" style="background: #b7472a;
