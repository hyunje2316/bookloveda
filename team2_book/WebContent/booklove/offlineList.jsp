  ...
  <script>
    	$(document).ready(function(){
    		<%if(session.getAttribute("memID")==null){%>
    			...
    			$('#offwrite').html("");
    		<%} else{%>
	    		$('#offwrite').attr("href","./OfflineWrite.book");
	    		$('#offwrite').attr("class","btn btn-primary py-2 px-4");
				$('#offwrite').html("Offline Club Now");
    		<%}%>
    	});

    </script>
    <title>BookLove多 - offline List</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span>Club - Offline<i class="fa fa-chevron-right"></i></span></p>
            <h2 class="mb-0 bread">Club - Offline</h2>
          </div>
        </div>
      </div>
    </section>
...
<c:when test="${listcount > 0 }">       
        <h4 class="product-select">Total :  ${listcount }</h4><br><br>
       ...
       <c:forEach var="vo" items="${ list }">
          ...
          <div class="col-lg-6 d-flex align-items-stretch ftco-animate">
          	...
          	<c:if test="${vo.o_address != null }">
          
	          	<a href="./OfflineViewAction.book?num=${ vo.o_no }" class="block-20 img" style="background-image: url(./dealUpload/${ vo.o_address });" >
	              </a>
			</c:if>			
			<c:if test="${vo.o_address == null }">
				<a href="./OfflineViewAction.book?num=${ vo.o_no }" class="block-20 img" style="background-image: url('images/noimage.jpg');">
	              </a>
			</c:if>
              ...
              <div class="text p-4 bg-light">
              	<div class="meta">
              		<p><span class="fa fa-calendar"></span>${ vo.o_date }</p>
              	</div>
                <h3 class="heading mb-3"><a href="./OfflineViewAction.book?num=${ vo.o_no }">${ vo.o_subject }</a></h3>
                
                <a href="./OfflineViewAction.book?num=${ vo.o_no }" class="btn-custom">Continue <span class="fa fa-long-arrow-right"></span></a>
...
<c:otherwise>     
          ...
          <div align="right" class="container">					
			   <p><a href="/team2_book/OfflineWrite.book" class="btn btn-primary py-2 px-4"style="padding: 1.5rem !important;" id="offwrite">Offline Club Now</a> </p>
		</div>
				          ...
				          <div class="col text-center">
				            <div class="block-27">
				              ...
				              <c:choose>
					            ...
					            <c:otherwise>
					            <li><a href="./BookOfflineList.book?page=${page-1 }">&lt;</a></li>
				            ...
				            <c:forEach var="a" begin="${startPage }" end="${endPage }" step="1">
					            ...
					            <c:otherwise>
					            <li><a href="./BookOfflineList.book?page=${a }">${a }</a></li>
