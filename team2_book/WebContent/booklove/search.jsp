...
<!-- 	 
    ...
    <section class="ftco-section bg-light">
			...
			<div align="center" style="width:1170px;">
				...
				<br>
           		<div class="form-group"  style="width:1000px; padding-bottom: 50px;">
		            ...
		            <input type="text" name="search" id="search" placeholder="   제목으로 검색합니다."style="width:800px; height: 50px; border-color: #808080">
		          <!--  
		           	<input type="image" src="./images/search.png"  value="" /> -->
		           <button id="ss" style="border: 0px;"><img src="./images/search4.png" width="40px" height="40px" id="search"></button>
			...
			<div style="width: 1170px; height: 30px; padding: 50px;" align="center">
