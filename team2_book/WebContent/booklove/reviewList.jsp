...
<html lang="en">
  <head>
	...
	<script>
    	$(document).ready(function(){
    		<%if(session.getAttribute("memID")==null){%>
    			...
    			$('#wrta').html("");
    		<%} else{%>
	    		$('#wrta').attr("href","./ReviewWrite.book");
	    		$('#wrta').attr("class","btn btn-primary py-2 px-4");
    ...
    <title>BookLove多 - review List</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="home.book">Home <i class="fa fa-chevron-right"></i></a></span> <span>Review <i class="fa fa-chevron-right"></i></span></p>
						  ...
						  <tbody>
						    <tr class="alert" role="alert">
						    	...
						    	<c:if test="${vo.r_image != null }">
									<div class="img" style="background-image: url(./reviewUpload/${ vo.r_image });" ></div>
									
									</c:if>
									<c:if test="${vo.r_image == null }">
									<div class="img" style="background-image: url('images/noimage.jpg');" ></div>
						      ...
						      <td>
						      	<div class="email">
						      		<span><a href="./ReviewDetailAction.book?num=${ vo.r_no }"><h4>${ vo.r_subject }</h4></a></span>
...
<c:otherwise>
						...
						<div class="col-md-9">
							<div class="row mb-4">
								<div
									...
									<br>
									<br> <select class="selectpicker" multiple>
							...
							<div class="row">
								...
								<br>
								<br>
								<br> <font size=4>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	...
	<div align="center">					
   <p><a href="/team2_book/ReviewWrite.book" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important;" id="wrta">Review Now</a> </p>
   </div>
		          ...
		          <div class="col text-center"style="padding-bottom: 50px;">
		            <div class="block-27">
				              ...
				              <c:choose>
					            ...
					            <c:otherwise>
					            <li><a href="./bookReviewList.book?page=${page-1 }">&lt;</a></li>
				            ...
				            <c:forEach var="a" begin="${startPage }" end="${endPage }" step="1">
					            ...
					            <c:otherwise>
					            <li><a href="./bookReviewList.book?page=${a }">${a }</a></li>
