...
<!-- 	      
    ...
    <section class="ftco-section bg-light">
			<div class="container">
				...
				<form action="OfflineInsertAction.book" method="post"	enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-12" style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="o_subject" id="subject" placeholder="Subject" required>
													</div>
												</div>
												...
												<div class="col-md-6"style="padding-bottom: 10px;"> 
													<div class="form-group">
														...
														<input name="o_address" type="file"/>
													</div>
												</div>
												...
												<div class="col-md-12"style="padding-bottom: 10px;">
													<div class="form-group">
														...
														<textarea name="o_content" class="form-control" id="d_content" cols="30" rows="10" placeholder="input content..." required></textarea>
													</div>
												</div>
												<div class="col-md-12">
