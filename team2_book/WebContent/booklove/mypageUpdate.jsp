...
tr:nth-child(even) {
  background-color: #f2f2f2;
						...
						<div class="signup-form">
						    <form action="./BookUserUpdate.book" method="post" name="userUpdate">
								<h2>회원 정보 수정</h2>
								<hr>
						        <div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" name="M_ID" placeholder="ID" required="required" value="${memID }" readonly>
									</div>
						        </div>
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="password" class="form-control" name="M_UPDATEPWD" placeholder="Confirm Password" required>
									</div>
						        </div>
						        <div class="form-group">
						        	이름
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
										<input type="text" class="form-control" name="M_NAME" placeholder="Username" required>
									</div>
						        </div>
						         <div class="form-group">
						         	주소
									<div class="input-group">
										...
										<input type="text" class="form-control" name="M_ADDRESS" placeholder="Address" required>
									</div>
						        </div>
