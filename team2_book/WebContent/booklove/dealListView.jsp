...
<html lang="en">
  <head>
    ...
    <title>BookLove多 - deal List</title>
    <meta charset="utf-8">
...
window.onload = function(){
	...
	$.ajax({
		...
		success: function(data, textStatus){
			...
			memberInfo += '<form action="./DealCommentSubmit.book" method="post">';
			memberInfo += '<input type="hidden" name="c_board_no" value="${ vo.d_no }">';
			memberInfo += '<textarea name="deal_comment" cols="30" rows="5" class="form-control"></textarea><br>';
			...
			for(i in jsonInfo.members){
				...
				memberInfo += '<p><a style="color: #BBAA55" href="./DealCommDelAction.book?id=' + jsonInfo.members[i].id + '&num=${ vo.d_no }&no=' + jsonInfo.members[i].no + '">삭제</a></p>';
				memberInfo += '</div>';
				memberInfo += '</li>';
			}
			memberInfo += "</ul>";
...
<!-- 	      
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="./dealUpload/${ vo.d_state_image }" class="image-popup prod-img-bg"><img src="./dealUpload/${ vo.d_state_image }" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    			
    				<p class="text-left mr-4">
							<c:if test="${ vo.d_category == 1 }">							
								<a href="#" class="mr-2" style="color: #000;"><span style="color: #bbb;">Category : 문학</span></a>
							</c:if>
							<c:if test="${ vo.d_category == 2 }">							
								<a href="#" class="mr-2" style="color: #000;"><span style="color: #bbb;">Category : 인문</span></a>
							</c:if>
							<c:if test="${ vo.d_category == 3 }">							
								<a href="#" class="mr-2" style="color: #000;"><span style="color: #bbb;">Category : 사회/과학/예술</span></a>
							</c:if>
							<c:if test="${ vo.d_category == 4 }">							
								<a href="#" class="mr-2" style="color: #000;"><span style="color: #bbb;">Category : 학습/수험서/자격증</span></a>
							</c:if>
							<c:if test="${ vo.d_category == 5 }">							
								<a href="#" class="mr-2" style="color: #000;"><span style="color: #bbb;">Category : 만화/외국서적</span></a>
							</c:if>
							<c:if test="${ vo.d_category == 6 }">							
								<a href="#" class="mr-2" style="color: #000;"><span style="color: #bbb;">Category : 기타</span></a>
							</c:if>
						</p>
							
							
    				<h3>SUBJECT : ${ vo.d_subject }</h3>
    				<br>
    				<div class="rating d-flex" >
							<p class="text-left mr-4">
								<a href="" class="mr-2" style="color: #000;">등급 : ${ vo.d_state }.0</a> &nbsp;&nbsp;
						...
						<br>
						<p style="color: black;">작성자 : ${ vo.m_id }</p> <br><br>
    				<p class="price"><span><span class="price"><fmt:formatNumber value="${ vo.d_price }" pattern="#,###" /> 원</span></p>
    				<br><br>
   ...
   <a href="bookDealList.book?category=${ vo.d_category }" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important;">List</a> &nbsp;&nbsp;&nbsp;
   
   </c:if>
   <c:if test="${ sessionScope.memID == vo.m_id }">
   <a href="bookDealList.book?category=${ vo.d_category }" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important;">List</a> &nbsp;&nbsp;&nbsp;
   <a href="DealUpdate.book?num=${ vo.d_no }" class="btn btn-primary py-2 px-4" style="padding: 1.5rem !important;">Update</a> &nbsp;&nbsp;&nbsp;
   	<a href="DealDelete.book?num=${ vo.d_no }&category=${ vo.d_category }" class="btn btn-primary py-2 px-4"style="padding: 1.5rem !important;">Delete</a>
   
   </c:if>
   </p>
   </div>
   
   <input type="hidden" name="d_board_no" id="d_board_no" value="${ vo.d_no }"> <!-- 글번호 -->
   <div class="container">
	   <div class="pt-5 mt-5" id="deal_comm"></div>
	</div>
